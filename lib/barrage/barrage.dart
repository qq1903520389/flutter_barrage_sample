...
class BarrageState extends State<Barrage> {
  ...
  int barrageIndex = 0;
   ...
   Function stopMonitorAction;


 void setStopMonitorAction(Function stopMonitorAction){
   if(stopMonitorAction!=null){
  ...
  _onComplete(id) {
    if(stopMonitorAction!=null) {
      stopMonitorAction(true, "动画执行完毕删除");
    }
    print("动画执行完毕删除");
    //动画执行完毕删除
